<template>
    <div>
            ...
            <mt-loadmore :top-method="loadTop" top-pull-text="加载更多" top-drop-text="释放加载" @top-status-change="handleTopChange" ref="loadmore">
                <ul>
                    <template v-for="item in records">
                        <li class="chat-mine" v-if="item.type==1" :key="item.code">
                        ...
                        <li class="chat-else" v-if="item.type==2" :key="item.code">
        ...
        <section class="foot">
            ...
            <span class="btn-face" v-on:click="showSelBox=showSelBox==1?0:1"><span class="icon iconfont">&#xe630;</span></span>
            <span class="btn-plus" v-on:click="showSelBox=showSelBox==2?0:2"><span class="icon iconfont">&#xe71b;</span></span>
                    ...
                    <mt-swipe :auto="0" :continuous="false">
                        <mt-swipe-item v-for="n in Math.ceil(EXPS.length/18)" :key="n">
                            <li v-for="(item, index) in getEXP(n,18)" :key="index">
                                <img :src="'emotion/'+item.file" alt="" :data="item.code" v-on:click="content+=item.code">
                            </li>
                        </mt-swipe-item>
                    </mt-swipe>
                </section>
    ...
    methods: {
        ...
        replaceFace:function(con){
            ...
            for(var i=0;i<exps.length;i++){
                ...
                con = con.replace(exps[i].reg, '<img src="emotion/' + exps[i].file +'"  alt="" />');
            }
            return con;
        },
